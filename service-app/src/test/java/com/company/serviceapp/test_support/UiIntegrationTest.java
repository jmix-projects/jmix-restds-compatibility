 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.serviceapp.screen")
@ContextConfiguration(classes = {ServiceAppApplication.class, UiTestAssistConfiguration.class})
